...
import * as jsoncEslintParser from "../../../lib/index.mjs";
...
`,
  ...
  methods: {
    ...
    handleCursor(evt, editor) {
      ...
      /**
       * Find the location data for a given position in the AST JSON.
       */
      ...
      /**
       * Check if a given position is within a location.
       */
...
/**
 * Process a value and append it to the AST JSON context.
 */
